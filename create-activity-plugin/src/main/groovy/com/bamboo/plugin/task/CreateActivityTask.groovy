...
import com.bamboo.plugin.template.ActivityNodeTemplate
import com.bamboo.plugin.template.ActivityTemplate
import com.bamboo.plugin.template.XmlTemplate
...
class CreateActivityTask extends DefaultTask{
    ...
    @TaskAction
    void createActivity() {
        def extension = project.extensions.findByType(new CreateActivityExtension())
